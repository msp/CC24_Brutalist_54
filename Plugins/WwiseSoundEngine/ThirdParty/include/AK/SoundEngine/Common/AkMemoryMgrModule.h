...
struct AkMemSettings
{
	...
	/// @name Configuration.
	//@{
	AK::MemoryArena::AkMemoryArenaSettings     memoryArenaSettings[AkMemoryMgrArena_NUM]; ///< Configuration of memory arenas for default memory allocator. For more information, see \ref goingfurther_optimizingmempools_memoryarena.
