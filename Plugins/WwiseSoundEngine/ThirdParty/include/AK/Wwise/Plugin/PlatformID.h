...
inline BasePlatformID ak_wwise_create_base_platform_id()
{
	BasePlatformID base_platform_id;
	base_platform_id.guid = GUID_NULL;
	return base_platform_id;
}
